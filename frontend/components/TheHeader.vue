			...
			<div id="navbarSupportedContentY" class="navbar-collapse collapse grow items-center">
				<ul class="navbar-nav mr-auto lg:flex lg:flex-row">
					...
					<li class="nav-item mb-2 lg:mb-0">
						<a class="nav-link block pr-2 lg:px-2 py-2 text-gray-600 hover:text-gray-700 focus:text-gray-700 transition duration-150 ease-in-out" href="#!" data-mdb-ripple="true" data-mdb-ripple-color="light" @click.prevent="logout">Cerrar Sesión</a>
					</li>
				</ul>
			</div>
		</div>
